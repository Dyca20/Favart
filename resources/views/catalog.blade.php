...
<body class="bg-slate-50">
    ...
    <main class="flex flex-col">
        ...
        <div class="flex ml-20 pb-10 space-x-3 w-auto">
            ...
            <button id="dropdownDefault" data-dropdown-toggle="dropdown"
                class="text-white bg-slate-600 hover:bg-slate-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center "
                type="button">Filtrar <svg class="ml-2 w-4 h-4" aria-hidden="true" fill="none" stroke="currentColor"
        ...
        <section class="flex pt-0 p-16 space-x-6">
            <div
                class="max-w-xs bg-white rounded-lg shadow-sm hover:shadow-md hover:-translate-y-1 bg-whiteborder-gray-700">
                <a href="#" data-modal-toggle="defaultModal">
                    <img class="p-2 rounded-t-lg" src="{{ URL::asset('images/carousel/post_1.jpg') }}"
                        alt="product image">
                    <hr class="pb-2">
                </a>
                <div class="px-5 pb-5">
                    <a href="#">
                        <h5 class="text-xl font-semibold tracking-tight text-gray-900">Argollitas de
                            acero
                        </h5>
                    </a>
                    <a href="#">
                        <h5 class="text-sm font-semibold tracking-tight text-gray-600 pb-2">Con
                            cristales
                            -
                    ...
                    <div class="flex justify-between items-center">
                        <span class="text-2xl font-bold text-gray-900 ">₡7500</span>
            ...
            <div class="max-w-xs rounded-lg hover:shadow-md hover:-translate-y-1 bg-white border-gray-700">
                <a href="#" data-modal-toggle="defaultModal">
                    <img class="p-2 rounded-t-lg" src="{{ URL::asset('images/carousel/post_2.jpg') }}"
                        alt="product image">
                    <hr class="pb-2">
                </a>
                <div class="px-5 pb-5">
                    <a href="#">
                        <h5 class="text-xl font-semibold tracking-tight text-gray-900 ">Pulsera de acero
                        </h5>
                    </a>
                    <a href="#">
                        <h5 class="text-sm font-semibold tracking-tight text-gray-600  pb-2">Esepecial
                            Día
                            de la Madre
                        </h5>
                    </a>
                    <div class="flex justify-between items-center">
                        <span class="text-2xl font-bold text-gray-900 ">₡5000</span>
                        <a href="/#"><button type="button"
                                class="text-white bg-red-400 hover:bg-red-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 ">
                                <svg aria-hidden="true" class="mr-2 -ml-1 w-5 h-5" fill="currentColor"
                                    viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="max-w-xs rounded-lg hover:shadow-md hover:-translate-y-1 bg-white border-gray-700">
                <a href="#" data-modal-toggle="defaultModal">
                    <img class="p-2 rounded-t-lg" src="{{ URL::asset('images/carousel/post_3.jpg') }}"
                        alt="product image">
                    <hr class="pb-2">
                </a>
                <div class="px-5 pb-5">
                    <a href="#">
                        <h5 class="text-xl font-semibold tracking-tight text-gray-900 ">Signos
                            sodiacales
                        </h5>
                    </a>
                    <a href="#">
            ...
            <div id="defaultModal" tabindex="-1" <div id="defaultModal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative p-4 w-full max-w-3xl h-full md:h-auto">
                    <div class="relative bg-white rounded-lg shadow">
                        ...
                        <div class="flex flex-row">
                            <div class="w-9/12">
                                {{-- imagen del producto --}}
                                <img class=" object-cover" src="{{ URL::asset('images/carousel/post_1.jpg') }}">
                            </div>
                            <div class="p-6 space-y-3">
                                <div class="flex flex-row justify-between">
                                    <h2 class="text-base leading-relaxed text-gray-500">
                                        <strong>Categoría:</strong> <a class="text-blue-600 hover:underline"
                                            href="/#">Argollas</a>
                                    </h2>
                                    {{-- precio --}}
                                    <h2 class="text-base leading-relaxed text-gray-500 mr-6">
                                        <strong>Precio:</strong> <span class="text-red-400">₡5000</span>
                                </div>

                                <h2 class="text-base leading-relaxed text-gray-500">
                                    <strong>Descripción:</strong>
                                    <p class="text-gray-600 ">
                                        El Dorado y las Perlas siempre la más linda combinación 😍
                                ...
                                <div class="flex flex-row space-x-6">
                                    <div class="flex flex-col items-center ">
                                        <img class="w-24 h-24 shadow-lg hover:scale-[3] hover:transition"
                                            src="{{ URL::asset('images/carousel/post_2.jpg') }}">
                                        <p class="text-sm font-semibold text-gray-600 pt-3">
                                            Accecorio 1
                                        </p>
                                        <a href="/#"><span
                                                class=" bg-pink-100 text-red-400 text-sm font-medium mr-2 px-2.5 
                                                py-0.5 rounded">Añadir</span></a>
                                    </div>
                                    <div class="flex flex-col items-center">
                                        <img class="w-24 h-24 shadow-lg hover:scale-[3] hover:transition"
                                            src="{{ URL::asset('images/carousel/post_3.jpg') }}">
                                        <p class="text-sm font-semibold text-gray-600 pt-3">
                                            Accecorio 2
                                        </p>
                                        <a href="/#"><span
