            ...
            <div class="w-64 max-h-[395px] min-w-[288px] rounded-lg shadow-sm hover:shadow-md hover:-translate-y-1 bg-white border-gray-700">
                ...
                <div class="px-5 pb-5">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{url('/addProductCarrito/'.$producto -> idProducto)}}"><button type="button" class="text-white bg-red-400 hover:bg-red-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-1.5 text-center inline-flex items-center mr-0 ">
