    ...
    <main class="flex pl-20 pr-20 pt-10 flex-col h-screen">
        <div class="flex pl-10 justify-between bg-red-300 h-24 rounded-md">
            <h1 class="flex gap-2 items-center text-4xl font-semibold text-white">
                <i class="gg-shopping-bag"></i>Catálogo
            </h1>
            <img class="object-cover w-66" src="{{ URL::asset('images/5088260.png') }}" alt="">
        </div>
        <div class="flex mt-5 p-10 space-x-3 w-auto shadow-sm bg-white">
            ...
            <form class="flex space-x-2" method="POST" action="{{ url('/catalog/searcher') }}" enctype="multipart/form-data">
                @csrf
                ...
                <button class="bg-rose-400 hover:bg-rose-300 text-white font-bold px-4 py-2 rounded shadow-lg hover:transition duration-500 " type="submit">
                    Buscar
                </button>
            </form>
            <a href="{{ url('/catalog') }}">
                <button class="bg-rose-400 hover:bg-rose-300 text-white font-bold px-4 py-2 rounded shadow-lg hover:transition duration-500" type="button">
                    Mostrar Todo
                </button>
            </a>
        </div>
        <section class="flex flex-wrap justify-items-start gap-y-3 gap-x-3 mt-10 pt-0 p-16 content-start">
            @foreach ($productos as $producto)
            <div class="w-64 max-h-[395px] min-w-[288px] rounded-lg shadow-sm hover:shadow-md hover:-translate-y-1 bg-white border-gray-700">
                <a href="#" data-modal-toggle="{{ $producto->nombreProducto }}">
                    <div class="flex w-[288px] h-64 justify-center">
                        <img class="p-2 rounded-t-lg object-cover" src="{{ URL::asset('images/productos/' . $producto->imagen) }}" alt="product image">
                    </div>
                    <hr class="pb-2">
                </a>
                <div class="px-5 pb-5">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a>
                            <button type="button" data-modal-toggle="{{ $producto->nombreProducto }}" class="text-white bg-red-400 hover:bg-red-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-1.5 text-center inline-flex items-center mr-0 ">
                ...
                <div class="relative p-4 w-full max-w-3xl h-full md:h-auto">
                    <div class="relative bg-white rounded-t-lg shadow">
                        ...
                        <div class="flex flex-row h-72 w-full">
                            {{-- imagen del producto --}}
                            <div class="flex flex-grow h-72 w-72 max-w-[288px] min-w-[288px] justify-center border-r-2 border-gray-100">
                                <img class="p-2 rounded-t-lg object-contain" src="{{ URL::asset('images/productos/' . $producto->imagen) }}" alt="product image">
                            </div>
                            <div class="p-6 space-y-3 flex flex-col overflow-y-auto" style="width: inherit">
                                <div class="flex justify-between">
                                    ...
                                    {{-- precio --}}
                                    <div class="flex">
                                        <h2 class="text-base text-gray-500">Precio: <span class="text-red-400">₡{{ $producto->precio }}</span>
                                        </h2>
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-row space-x-6 pt-2">
                                    ...
                                    <div class="flex flex-col items-center">
                                        <img class="w-24 h-24 shadow-lg hover:scale-[3] hover:shadow-2xl hover:transition hover:z-10 rounded-md overflow-visible" src="{{ URL::asset('images/productos/' . $accesorio->imagen) }}">
                                        <div class="flex flex-col items-center">
                                            <p class="flex text-sm font-semibold text-gray-600 pt-3">
                                                {{ $accesorio->nombreProducto }}
                                            </p>
                                            <a class="flex" href="/#">
                                                <span class=" bg-pink-100 text-red-400 text-sm font-medium mr-2 px-2.5 py-0.5 rounded">Añadir
                                                </span>
                                            </a>
                                        </div>
                                    </div>
