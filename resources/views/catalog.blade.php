    ...
    <main class="flex flex-col h-screen">
        ...
        <div class="flex ml-20 pb-10 space-x-3 w-auto bg-white">
            ...
            <form method="POST" action="{{ url('admin/buscador') }}" enctype="multipart/form-data">
                ...
                <div class="flex gap-x-2">
                    ...
                    <button
                        class="bg-rose-400 hover:bg-zinc-500 text-white font-bold px-4 py-2 rounded shadow-lg hover:transition duration-500  mb-3"
                        type="submit">
                        Buscar
                    </button>
                </div>
        ...
        <section class="flex flex-wrap justify-items-start gap-y-3 gap-x-3 pt-0 p-16 content-start">
            @foreach ($productos as $producto)
                ...
                <div id="{{ $producto->nombre_Producto }}" tabindex="-1" aria-hidden="true"
                        ...
                        <div class="relative bg-white rounded-t-lg shadow">
                            <div class="flex justify-between items-start p-4 rounded-t border-b">
                                ...
                                <button type="button"
                                    ...
                                    data-modal-toggle="{{ $producto->nombre_Producto }}">
                            ...
                            <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 bg-white">
                                ...
                                {{-- <button type="button"
                    class="text-white bg-gray-400 hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">
