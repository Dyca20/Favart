                    ...
                    <ul
                        ...
                        <li>
                            <a href="/admin/manageInventory"
                                ...
                                aria-current="inventario">Gestionar inventario</a>
                        </li>
                        <li>
                            <a href="/admin/accounting"
                                class="block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-red-400 md:p-0 "
                                aria-current="contabilidad">Contabilidad</a>
                        </li>
                        <li>
                            <a href="/admin/history"
                                class="block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-red-400 md:p-0 "
                                aria-current="historial">Historial</a>
                        </li>
                        <li>
                            ...
                            @if (Auth::check())
                                <a class="block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-red-400 md:p-0"
                                    href="{{ url('admin/' . Auth::User()->idUsuario) . '/perfil' }}" class="px-2 mx-2"
                                    aria-current="user">
