...
<body class="bg-slate-50 h-screen w-screen overflow-x-hidden">
    ...
    <main class="flex pl-20 pr-20 pt-10 flex-col h-screen">
        ...
        <div class="flex mt-10 space-x-3 w-auto m-0 ">
            <div class="w-full m-auto shadow-sm relative overflow-visible">
                    ...
                    <tbody>
                        @foreach ($historiales as $index => $historial)
                            <tr class="bg-white border-b hover:bg-gray-5">
                                <th scope="row"
                                    class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap max-w-xs">
                            ...
                            <td class="py-4 px-6">
                                @foreach ($users as $usuario)
                                    @if ($usuario->idUsuario == $historial->idUsuario)
                                        <a>
                                            <button type="button" data-modal-toggle="{{ $usuario->nombreUsuario }}"
                                                class="underline text-blue-600">
                                                {{ $usuario->nombreUsuario }}
                                            </button></a>
                                    @endif
                                    <div id="{{ $usuario->nombreUsuario }}" tabindex="-1" aria-hidden="true"
                                            ...
                                            <div class="relative bg-white rounded-t-lg rounded-b-lg shadow">
                                                <div
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        data-modal-toggle="{{ $usuario->nombreUsuario }}">
                                                ...
                                                <div class="flex flex-row h-56 w-full">
                                                    {{-- imagen del producto --}}
                                                    <div class="p-6 pl-10 pr-10 space-y-5 flex flex-col overflow-y-auto"
                                                        style="width: inherit">
                                                        <div class="flex flex-col">
                                                            <h3 class="font-bold text-gray-500 text-base">Nombre
                                                                completo</h3>
                                                            <p class="text-base leading-relaxed text-gray-500">
                                                                {{ 'Tinni' }} {{ 'Gonzalez Matarrita' }}
                                                            </p>
                                                        </div>
                                                        <div class="flex justify-between">
                                                            <div class="flex flex-col">
                                                                ...
                                                                <p class="text-base leading-relaxed text-gray-500">
                                                                    <a class="text-blue-600" target="_blank"
                                                                        data-tooltip-target="tooltip-telefono"
                                                                        href="https://wa.me/{{ '85049932' }}">
                                                                        {{ '85049932' }}
                                                                    </a>
                                                                <div id="tooltip-telefono" role="tooltip"
                                                            ...
                                                            <div class="flex flex-col">
                                                                ...
                                                                <div id="tooltip-correo" role="tooltip"
                                                                    class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip">
                                                        ...
                                                        <div class="flex flex-col">
                                                            ...
                                                            <p
                                                                class="leading-relaxed text-gray-500 w-auto text-sm">
                                                                {{ 'Contiguo al Supermercado Olivio, Casa Color Rojo' }}
                                                            </p>
                                                        </div>
                                                ...
                                                <!-- Modal footer -->
                                                <div class="flex items-center p-2 space-x-2 rounded-b border-t border-gray-200 bg-white"
                                                    data-modal-toggle="{{ $usuario->nombreUsuario }}">
                                                    <a><button type="button"
                                                            class="text-white bg-red-400 hover:bg-red-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2 text-center inline-flex items-center mr-2 ">
                                                            Cerrar
                                                        </button></a>
                                                </div>
                                            </div>
                            ...
                            <td class="py-4 px-6 space-x-2">
                                <button id="dropdownDefault" data-dropdown-toggle="dropdown"
                                    ...
                                    type="button">Estado <svg class="ml-2 w-4 h-4" aria-hidden="true"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M19 9l-7 7-7-7"></path>
                                    </svg></button>
                                <div id="dropdown"
                                    class="z-10 w-44 bg-white rounded divide-y divide-gray-100  hidden"
                                    data-popper-reference-hidden="" data-popper-escaped=""
                                    data-popper-placement="bottom"
                                    style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(319px, 70px);">
                                    <ul class="py-1 text-sm shadow-lg text-gray-700 "
                                        aria-labelledby="dropdownDefault">

                                        <li>
                                            <a href="{{ url('/admin/status/' . $historial->idUsuario) }}"
                                                class="block py-2 px-4 hover:bg-gray-100 ">Pendiente</a>
                                        </li>
                                        <li>
                                            <a href="{{ url('/') }}"
                                                class="block py-2 px-4 hover:bg-gray-100 ">En envío</a>
                                        </li>
                                        <li>
                                            <a href="{{ url('/') }}"
                                                class="block py-2 px-4 hover:bg-gray-100 ">Completado</a>
                                        </li>
                                    </ul>
                                </div>

                                <a href="{{ url('/admin/carritoHistorial/' . $historial->idHistorial . '/' . $historial->idUsuario) }}"
