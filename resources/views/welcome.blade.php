    ...
    <main class="h-screen">
        <section
            ...
            <div class="py-0">
                <div class="flex align-middle w-full z-0">
                    <div class="">
                        <div class="">
                            <div>
                                <span class="text-red-400 sm:text-6xl text-3xl font-bold font-sans">Fav Art. </span>
                                <span
                                    class="text-slate-700 sm:text-6xl text-3xl font-semibold font-sans">Accesorios</span>
                            </div>
                        </div>
                        <div>
                            <hr class="h-2">
                ...
                <div class="flex justify-center sm:justify-start space-x-6 mt-8 ">
                    <a href="/catalog" data-tooltip-target="tooltip-default"
                        class="z-40 bg-red-500 shadow-md hover:bg-red-400 text-white font-bold py-2 px-4 rounded-lg">
            ...
            <div class="hidden sm:flex w-96 -mt-32 ">
                <img src="{{ URL::asset('/images/person.png') }}" alt="logo"
                    class="w-full shadow-red-400 drop-shadow-2xl-red">
            </div>
        </section>
    </main>

    <div class="mt-36 sm:mt-44 md:mt-80 xl:mt-72 lg:mt-80 2xl:mt-20">
